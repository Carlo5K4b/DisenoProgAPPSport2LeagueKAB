...
namespace SportsLeague.Domain.Entities
{
    ...
    public class Match : AuditBase
    {
        ...
        // Add this navigation property for Cards --> Añadir esta propiedad de navegación para las tarjetas
        public ICollection<Card> Cards { get; set; } = new List<Card>();
        public ICollection<Goal> Goals { get; set; } = new List<Goal>();
        public MatchResult? MatchResult { get; set; } //#Esta relacionado con esta linea ---> Remove: .WithOne() 
