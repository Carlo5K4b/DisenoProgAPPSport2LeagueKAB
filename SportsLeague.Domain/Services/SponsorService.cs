...
namespace SportsLeague.Domain.Services
{
    public class SponsorService : ISponsorService
    {
        ...
        public async Task<TournamentSponsor> RegisterTournamentAsync(int sponsorId, TournamentSponsor tournamentSponsor)
        {
            ...
            var tournamentExists = await _tournamentRepository.GetByIdAsync(tournamentSponsor.TournamentId);
